...
const types = {
  "ERC": {
    ...
    modern: "『동경』(김화진), 『아몬드』(손원평), 『스토너』(존 윌리엄스)",
    classic: "『작은 아씨들』(루이자 메이 올컷), 『브람스를 좋아하세요...』(프랑수아즈 사강), 『콜레라 시대의 사랑』(가브리엘 가르시아 마르케스)"
  },
  "ERX": {
    name: "현실 감성 · 도전형",
    ...
    modern: "『모순』(양귀자), 『작별하지 않는다』(한강), 『파칭코』(이민진)",
    classic: "『안나 카레니나』(톨스토이), 『내가 죽어 누워 있을 때』(윌리엄포크너), 『그리스인 조르바』(니코스 카잔차키스)"
  },
  "EMC": {
    name: "상상 감성 · 편안형",
    ...
    modern: "『창문을 넘어 도망친 100세 노인』(요나스 요나손), 『해리포터』(조앤 K. 롤링)",
    classic: "『어스시의 마법사』(어슐러 K. 르 귄), 『오즈의 마법사』(라이먼 프랭크 바움)"
  },
  "EMX": {
    name: "상상 감성 · 도전형",
    ...
    modern: "『존재의 세 가지 거짓말』(아고타 크리스토프), 『1Q84』(무라카미 하루키), 『밤의 여행자들』(윤고은)",
    classic: "『잃어버린 시간을 찾아서』(마르셀 프루스트), 『변신』(카프카), 『마의 산』(토마스 만)"
  },
  "IRC": {
    name: "현실 아이디어 · 편안형",
    ...
    modern: "『피프티 피플』(정세랑), 『디디의 우산』(황정은), 『트러스트』(에르난 디아스)",
    classic: "『동물농장』(조지 오웰), 『걸리버 여행기』(조너선 스위프트), 『아Q정전』(루쉰)"
  },
  "IRX": {
    name: "현실 아이디어 · 도전형",
    ...
    modern: "『네타냐후』(조슈아 코언), 『표백』(장강명), 『태고의 시간들』(올가 토카르축)",
    classic: "『인 콜드 블러드』(트루먼 커포티), 『황금노트북』(도리스 레싱), 『파우스트』(괴테)"
  },
  "IMC": {
    name: "상상 아이디어 · 편안형",
    ...
    modern: "『가공범』(히가시노 게이고), 『칵테일 러브 좀비』(조예은), 『하우스메이드』(프리다 맥파든)",
    classic: "『오리엔트  특급 살인』(아가사 크리스티), 『팅커 테일러 솔져 스파이』(존 르 카레), 『빅 슬립』(레이먼드 챈들러)"
  },
  "IMX": {
    name: "상상 아이디어 · 도전형",
    ...
    modern: "『궤도』(서맨사 하비), 『황금물고기』(르클레지오)",
    classic: "『모비딕』(허먼 멜빌), 『솔라리스』(스타니스와프 렘), 『픽션들』(호르헤 루이스 보르헤스)"
  }
};
