...
const types = {
    "PDU": {
        ...
        books: "『트렌드 코리아 2026』(김난도 외), , 『백악관 말하기 수업』(아비지트 배너지,에스테르 뒤플로), 『인간관계론』(데일 카네기)"
    },
    "PDH": {
        name: "실용·데이터·기초형",
        ...
        books: "『힘든 시대를 위한 좋은 경제학』(아비지트 배너지,에스테르 뒤플로), 『데이터는 어떻게 인생의 무기가 되는가』(세스 스티븐스 다비도위츠), 『팩트풀니스』(한스 로슬링), 『중독은 뇌를 어떻게 바꾸는가』(저드슨 브루어)"
    },
    "PNU": {
        name: "실용·내러티브·시사형",
        ...
        books: "『학교의 슬픔』(다니엘 페낙), , 『있지만 없는 아이들』(은유),  『전쟁은 여자의 얼굴을 하지 않았다』(스베틀라나 알렉시예비치)"
    },
    "PNH": {
        name: "실용·내러티브·기초형",
        desc: "역사적 체험, 전통적인 서술에서 삶의 교훈을 찾습니다. 고전 르포나 인물 회고록을 통해 인간 사회의 보편적 패턴을 학습합니다. 책은 현실과 과거를 이어주는 다리이며, 인간의 본질에 대한 성찰의 기회입니다.",
        books: "『쇼펜하우어의 행복록과 인생론』(아르투어 쇼펜하우어), 『단단한 독서』(에밀 파게), (몽테뉴)『수상록』, 『명상록』(마르쿠스 아우렐리우스)"
    },
    "TDU": {
        name: "이론·데이터·시사형",
